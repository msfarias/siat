<?php
   ...
   */
  class wp_foundation_walker extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
      ...
      if ( empty( $item->title ) && empty( $item->url ) ) {
        ...
        $item_output .= '<a' . $attributes . ' class = "has-icon">';
  ...
  add_filter( 'wp_page_menu', array( 'wp_foundation_walker', 'items_default_wrap' ) );
  add_action( 'wp_head', array( 'wp_foundation_walker', 'items_remove_defaut_wrapper' ) );